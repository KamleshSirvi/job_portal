...
const Footer = () => {
  return (
    ...
    <footer className="container mx-auto px-4 py-6 mt-12 flex flex-col md:flex-row justify-between items-center border-t">
      <p className="text-gray-600">© 2024 JobPortal. All rights reserved.</p>
      <div className="flex space-x-4 mt-4 md:mt-0">
